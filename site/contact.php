...
<html>
  ...
  <body>
    ...
    <?php
    if(isset($_POST) AND isset($_POST['nom']) AND isset($_POST['prenom']) AND isset($_POST['mail']) AND isset($_POST['objet']) AND!isset($_POST['message'])){
        if (!empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['mail'])
            ...
            <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                    <body>
                       <div align="center"> 
                          ...
                          <br />
                            <h1> Un mail à été reçu (Contact) !</h1>
            ...
            header('Location:contactMessageEnvoye.php');}
              ...
              echo "Adresse mail non pas valide!";
            }
        }
        else
        {
