            ...
            <div>
                ...
                <div class="texteGauche">
                    ...
                    if($_SESSION['isConnected']&& $_SESSION['userType'] == "Administrator") : ?> 
                     <form action="index.php?redirect=user&function=gestionDesUtilisateurs"><button type="submit" class="boutonTest">Gestion des utilisateurs</button> 
                    <?php endif;?>
                    <?php if($_SESSION['isConnected']&& $_SESSION['userType'] == "Instructor") : ?> 
                    <form action="index.php?redirect=user&function=resultatsPilote"><button type="submit" class="boutonTest">Consulter les résulats des pilotes</button> 
                    <?php endif;?>
                    <?php if($_SESSION['isConnected']&& $_SESSION['userType'] == "Pilot") : ?> 
                    <form action="index.php?redirect=user&function=testEnLigne"><button type="submit" class="boutonTest">Consulter les résulats des pilotes</button> 
                    <?php endif;?>

                    <?php if(!$_SESSION['isConnected']) : ?> 
                    <form action="index.php?redirect=user&function=connexion"><button type="submit" class="boutonTest">Connectez-vous pour passer le test en ligne</button> 
                    <?php endif;?>
