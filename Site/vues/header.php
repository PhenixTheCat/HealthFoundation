...
<html>
    <header class="headerNonConnecte" >
            <div class = logoPrincipal >
                ...
                <h1 ><a href="index.php" class="bigTitle">Application Psychotechnique pour Pilotes</a></h1><h2>"Leader européen du matériel médical."</h2>
            ...
            <nav <?php  if(!$_SESSION['isConnected']) : ?> class="notConnectedNAV"<?php endif;?> 
                 ...
                 <?php  if($_SESSION['userType'] == "Administrator") : ?> class="adminNAV"<?php endif;?>       
                                                                                id="menu">
                <ul <?php  if($_SESSION['isConnected']&& $_SESSION['userType'] == "Instructor") : ?> class="instructorrightUL"<?php endif;?>
                    <?php  if($_SESSION['isConnected']&& $_SESSION['userType'] != "Administrator") : ?> class="connectedrightUL"<?php endif;?>
                ...
                <ul <?php  if($_SESSION['isConnected']&& $_SESSION['userType'] == "Instructor") : ?> class="instructorLeftUL"<?php endif;?>
                    <?php  if($_SESSION['isConnected']&& $_SESSION['userType'] != "Administrator") : ?> class="connectedLeftUL"<?php endif;?>>
					<?php endif;
                    if($_SESSION['userType'] == "Instructor") : ?>
                    <li><a href="index.php?redirect=user&function=resultatsPilote">Resultats Pilotes</a></li>
                </ul>
                <ul 
                    <?php  if($_SESSION['isConnected']&& $_SESSION['userType'] == "Instructor") : ?> class="instructorLeftUL"<?php endif;?>>
					<?php endif;
