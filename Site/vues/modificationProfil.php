      ...
      <div class="piloteModifMdpp">
        ...
        <fieldset>
          <form action="" method="post">
            ...
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifnom">
            <br>
            <label for="prenom" id="prenom"><?php echo _("Prénom ");?></label>
            <input type="text" name="prenom" id="prenom" value="<?php echo $user['first_name']; ?>">
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifprenom">
            <br>
            <label for="date"  ><?php echo _("Date de naissance ");?></label>
            <input type="date"  max="1999-01-01" min="1980-01-01" value="<?php echo $user['birthdate']; ?>" name="date" >
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifdate">
            <br>

            <label for="email" id="email"><?php echo _("Adresse e-mail");?></label>
            <input type="email" name="email" id="mail" value="<?php echo $user['email']; ?>">
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifemail">

            <br>
            <label for="adressePostale" id="adressePostale"><?php echo _("Adresse postale");?></label>
            <input type="text" name="adressePostale" id="adressePostale" value="<?php echo $user['adress']; ?>">
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifadresse">
            <br>
            <label for="codePostal" id="codePostal"><?php echo _("Code postal");?></label>
            <input type="string" name="codePostale" id="codePostale" value="<?php echo $user['postecode']; ?>">
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifcodepostal">
            <br>
            <label for="ville" id="ville"><?php echo _("Ville ");?></label>
            <input type="text" name="ville" id="ville" value="<?php echo $user['city']; ?>">
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifville">
            <br>
            <label for="pays" id="pays"><?php echo _("Pays ");?></label>
...
<select name="pays">
  ...
  <option value="Zimbabwe"><?php echo _("Zimbabwe ");?></option>
            ...
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifpays">
            <br>
            <label for="numeroDeTelephone" id="numeroDeTelephone"><?php echo _("Numéro de téléphone");?></label>
            <input type="string" name="numeroDeTelephone" id="numeroDeTelephone"
              value="<?php echo $user['phone_number']; ?>">
            <br>
            <input class="editButtons" type="submit" Value=<?php echo _("Enregistrer");?> name="modifnumero">
            <br>

            <a href="index.php?redirect=user&function=monCompte" class="submitButtons"><?php echo _("Retourner à la page Mon
              compte");?></a>
