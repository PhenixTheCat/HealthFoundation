...
<body>
  <div class="centrer_bloc">
    <div class="pageInscriptionSuite">
      ...
      <span>
        <a class="enteteInscription"><?php echo _(" Coordonnées ");?></a>
      ...
      <fieldset>
        ...
        <form action="" method="post">
          ...
          <h3><?php echo _(" Inscription Pilote ");?></h3>
          <?php endif;?>
          <?php if($_SESSION['signupCodeType'] == "structure") : ?>
          <h3><?php echo _(" Inscription Formateur ");?></h3>
          <?php endif;?>
          <label for="sex" id="sex">Sex <span class="etoile"> * </span> </label>
          <input type="radio" name="sex" value="Female"><?php echo _(" Femme");?>
          <input type="radio" name="sex" value="Male"><?php echo _(" Homme");?>
          <input type="radio" name="sex" value="Other"><?php echo _(" Autre");?> 
          <br>
          <label for="nom" id="nom"><?php echo _("Nom ");?><span class="etoile"> * </span> </label>
          <input type="text" name="nom" id="nom">
          <br>
          <label for="prenom" id="prenom"><?php echo _("Prénom ");?><span class="etoile"> * </span> </label>
          <input type="text" name="prenom" id="prenom">
          <br>
          <label for="date" id="date"><?php echo _("Date de naissance ");?><span class="etoile"> * </span> </label>
          <input type="date"  max="2005-01-01" min="1950-01-01" name="date" id="date">
          <br>
          ...
          <br>
          <label for="codePostal" id="codePostal"><?php echo _("Code postal ");?><span class="etoile"> * </span> </label>
          <input type="string" name="codePostal" id="codePostal">
          <br>
          <label for="ville" id="ville"><?php echo _("Ville");?></label>
          <input type="text" name="ville" id="ville">
          <br>
          <label for="pays" id="pays"><?php echo _("Pays ");?><span class="etoile"> * </span> </label>
          ...
          <br>
          <h5> (<span class="etoile"> * </span><?php echo _(" champ obligatoire");?> </h5>

          <input type="checkbox" name="politiqueDeConfidentialite" id="politiqueDeConfidentialite"><?php echo _(" J'ai lu et j'accepte
          la politique de confidentialité ");?><br>

          <input class="submitButtons" type="submit" Value=<?php echo _("Terminer l'inscription");?>
                 name="inscriptionSuite">
        </form>
      </fieldset>
    </div>
